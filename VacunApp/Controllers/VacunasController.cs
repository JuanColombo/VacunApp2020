...
namespace VacunApp.Controllers
{
    public class VacunasController : Controller
    {
        ...
        public VacunasController(VacunAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,PeriodoAplicacion,Beneficios")] Vacuna vacuna)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,PeriodoAplicacion,Beneficios")] Vacuna vacuna)
        {
            if (id != vacuna.Id)
            {
                return NotFound();
