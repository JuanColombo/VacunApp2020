...
namespace VacunApp.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public PacientesController(VacunAppContext context)
        {
            _context = context;
        }
        ...
        {
            var vacunAppContext = _context.Pacientes.Include(p => p.Calendario).Include(p => p.Tutor);
            return View(await vacunAppContext.ToListAsync());
        }
