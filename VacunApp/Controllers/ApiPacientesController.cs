...
namespace VacunApp.Controllers
{
    ...
    public class ApiPacientesController : ControllerBase
    {
        ...
        public ApiPacientesController(VacunAppContext context)
        {
            _context = context;
        }

        // GET: api/ApiPacientes
        [HttpGet]
